...
export default function() {
    ...
    let moveDrag = this.moveDrag = function(e) {
        if (isMove) {
            ...
            else if (that.clipBorderShape) {
                if (that.clipBorderShape.resize) {
                    that.clipBorderShape.resize(that.coordinateConvert(e.getPosition()), that.clipBorderShape.startPosition);
                }
            }
